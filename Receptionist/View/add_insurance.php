...
<body>
	...
	<div class="add-patient add-spec"> <!-- add-spec begin -->
		...
		<div class="form-add-patient form-add-spec"> <!-- form-add-spec begin -->
			<div class="container">
				<form method="post" action="?controller=Insurance&action=addInsurance">

                    <div class="form-group">
                        <label>Mã Bệnh Nhân</label> <sup style="color: red">*</sup>
                        <input type="text" name="pat_code" class="form-control" list="pats">
                        <datalist id="pats">
                            <?php 
                                foreach($pats as $pat){
                            ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="ins_code" type="text" placeholder="Mã thẻ BHYT">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Ngày hết hạn</label> <sup style="color: red">*</sup>
                                <input class="form-control date" name="ins_date" style="cursor: pointer" readonly type="text" placeholder="Ngày hết hạn">
                            </div>
                        </div>
                    </div>
					
					<button type="submit" class="btn" name="add_ins">Thêm BHYT</button>	

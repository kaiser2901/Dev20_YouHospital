...
<body>
	...
	<div class="breadcrumbs"> <!-- breadcrumbs begin -->
		...
		<div class="container">
			...
			<span>\</span>
			<a class="active" href="?controller=Department&action=getViewAdd">Thêm Chuyên Khoa</a>
	...
	<div class="add-patient add-spec"> <!-- add-spec begin -->
		...
		<div class="form-add-patient form-add-spec"> <!-- form-add-spec begin -->
			<div class="container">
				<form method="post" action="?controller=Department&action=addDepartment">
					<div class="form-group">
						<label>Tên Chuyên Khoa</label> <span style="color: red">*</span>
						<input class="form-control" type="text" name="dep_name" placeholder="Tên Chuyên Khoa">
					...
					<div class="form-group">
						<label>Mô Tả</label>
						<textarea class="form-control" type="text" name="dep_des" placeholder="Mô tả (không bắt buộc)"></textarea>
					</div>
					
					<button type="submit" class="btn" name="add_dep">Thêm Chuyên Khoa</button>	

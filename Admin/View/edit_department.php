...
<body>
	...
	<div class="breadcrumbs"> <!-- breadcrumbs begin -->
		...
		<div class="container">
			...
			<span>\</span>
			<a href="?controller=Department">Danh Sách Chuyên Khoa</a>
			<span>\</span>
			<a class="active" href="?controller=Department&action=getViewEdit">Sửa Chuyên Khoa</a>
	...
	<div class="add-patient edit-spec"> <!-- edit-spec begin -->
		...
		<div class="form-add-patient form-edit-spec"> <!-- form-add-spec begin -->
			<div class="container">
				<form method="post" action="?controller=Department&action=editDepartment">
					
					<input type="hidden" name="dep_code" value="<?=$dep['dep_code']?>">
					<div class="form-group">
						<label>Tên Chuyên Khoa</label> <span style="color: red">*</span>
						<input class="form-control" type="text" name="dep_name" value="<?=$dep['dep_name']?>" placeholder="Tên Chuyên Khoa">
						<input class="form-control" type="hidden" name="dep_old_name" value="<?=$dep['dep_name']?>">
					...
					<div class="form-group">
						<label>Mô Tả</label>
						<textarea class="form-control" type="text" name="dep_des" placeholder="Mô tả (không bắt buộc)"><?=$dep['dep_description']?></textarea>
					</div>
					
					<button type="submit" class="btn" name="edit_dep">Sửa Chuyên Khoa</button>	

				</form>
			</div>
			

		</div> <!-- form-edit-spec finish -->

	</div> <!-- edit-spec finish -->
